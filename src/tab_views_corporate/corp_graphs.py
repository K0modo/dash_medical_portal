...
def make_services_icd_racing_chart(table):
    ...
    fig = go.Figure(
        ...
        layout=go.Layout(
            ...
            title=dict(text='Injury_Disease Category: Period 1',
                       font=dict(size=28),
                       x=0.5,
                       xanchor='center'
                       ),
...
def make_services_specialty_racing_chart(table):
    ...
    fig = go.Figure(
        ...
        layout=go.Layout(
            ...
            title=dict(text='Specialty Category: Period 1',
                       font=dict(size=28),
                       x=0.5,
                       xanchor='center'
                       ),
        ...
        frames=[
            go.Frame(
                data=[
                    go.Bar(x=value['claim_count_ytd'],
                           y=value['name'],
                           orientation='h',
                           text=value['claim_count_ytd'],
                           marker={'color': value['color_code']}
...
def make_services_facility_racing_chart(table):
    ...
    fig = go.Figure(
        ...
        layout=go.Layout(
            ...
            title=dict(text='Facility Category: Period 1',
                       font=dict(size=28),
                       x=0.5,
                       xanchor='center'
                       ),
